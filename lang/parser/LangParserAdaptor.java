...
// /**
// * Percorre a árvore de sintaxe abstrata (AST) a partir de um nó raiz e
// adiciona
// * todas as definições de estruturas de dados encontradas à tabela de dados
// * (`DataTable`).
// *
// * A função verifica se os comandos dentro de um `StmtList` (lista de
// comandos)
// * são instâncias de `Data`, representando definições de estruturas de dados,
// e
// * as adiciona
