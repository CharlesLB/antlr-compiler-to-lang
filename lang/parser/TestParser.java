...
// // Adaptador para classe de parser. a Função parseFile deve retornar null
// caso o parser resulte em erro.
...
// } else {
// System.out.println("O caminho " + f.getPath() + " não é um diretório ou não
// existe.");
// }
