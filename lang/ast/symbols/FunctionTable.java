...
// throw new RuntimeException("A função `main` já foi definida e só pode existir
// uma.");
// }
...
// functions.computeIfAbsent(functionName, k -> new
...
// if
// (!function.getParams().get(i).getType().toString().equals(paramTypes.get(i)))
// {
// matches = false;
// break;
// }
